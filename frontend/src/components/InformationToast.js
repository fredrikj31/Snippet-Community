...
class InformationToast extends React.Component {
	constructor(props) {
		super(props);
			...
			return (
				<div className="absolute bottom-16 right-16">
					<div className="flex bg-white dark:bg-gray-800 w-full mx-auto overflow-hidden rounded-lg shadow-lg">
						<div className="flex items-center justify-center w-12 bg-blue-500 text-white">
							<FontAwesomeIcon icon={faInfoCircle}></FontAwesomeIcon>
						</div>
		
						<div className="grid grid-rows-2 my-2">
							<div className="text-blue-500 font-semibold ml-3">{this.props.title}</div>
